...
if !app.validate_args
  ...
  app.startup do
    require 'config/anim/anim_config'
    require 'config/anim/pet_anim_config'
    require 'config/anim/monster_anim_config'
    require 'config/anim/role_anim_config'
    require 'config/anim/map_anim_config'
