...
require 'messages/update_pet_lv_message'
...
require 'viewmodels/game_modules/game_shit_mine'
...
require 'viewmodels/enemy_view_model'
...
require 'viewmodels/shit_mine_view_model'
...
if !app.validate_args
  ...
  app.startup do
    ...
    require 'config/equipment_wing_config'
