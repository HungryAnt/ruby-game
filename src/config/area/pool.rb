...
area_black_hole = create_area(:pool_black_hole, 'map/pool/black_hole.jpg',  nil, black_hole_tiles_text)
area_black_hole.auto_scale = true
area_black_hole.dynamic_background = true


area_pool_1.gateway = {
    A: {area: area_pool_2, direction: Direction::DOWN},
    C: {area: area_black_hole, direction: Direction::UP}
}
...
area_black_hole.gateway = {
    D: {area: area_pool_1, direction: Direction::DOWN}
}
...
create_map(:pool, '山涧水洼', MapType::VILLAGE, [area_pool_1, area_pool_2, area_black_hole])
